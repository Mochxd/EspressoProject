...
public class MainActivityTest1 {
    ...
    public void mainActivityTest1() {
        ViewInteraction editText = onView(
                allOf(withId(R.id.editTextUserInput),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        editText.perform(replaceText("Hello TAU"), closeSoftKeyboard());
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.editTextUserInput), withText("Hello TAU"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        editText2.check(matches(withText("Hello TAU")));
    }
